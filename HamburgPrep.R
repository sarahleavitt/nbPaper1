...
hamPair <- (snpDistDf
             ...
             %>% mutate(Nationality = ifelse(Nationality.1 == "Germany" &
                        ...
                        Nationality = factor(Nationality, levels = c(1, 2, 3, 4),
                                             labels = c("Same-Germany","Same-Other", "Diff-Germany",
                                                        "Diff-Other")),
                        Age = ifelse(AgeGroup.1 == AgeGroup.2, 1, 0),
                        Age = factor(Age, levels = c(1, 0),
                        ...
                        SubstanceAbuse = factor(SubstanceAbuse, levels = c(1, 2, 3),
                                                labels = c("Both", "Neither", "Different")),
                        ...
                        Residence = factor(Residence, levels = c(1, 2, 3),
                                           labels = c("BothStable", "BothHomeless", "Different")),
                        Milieu = ifelse(Milieu.1 == 1 & Milieu.2 == 1, 1,
                                        ifelse(Milieu.1 == 0 & Milieu.2 == 0, 2, 3)),
                        Milieu = factor(Milieu, levels = c(1, 2, 3),
                                        labels = c("BothAssociated", "BothNot", "Different")),
                        Study = ifelse(Study.1 == Study.2, 1, 0),
                        Study = factor(Study, levels = c(1, 0), labels = c("Same", "Different")),
                        Branch = ifelse(Branch.1 == Branch.2, 1, 0),
                        Branch = factor(Branch, levels = c(1, 0), labels = c("Same", "Different")),
